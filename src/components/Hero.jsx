    ...
    <section className={`relative w-full h-screen mx-auto`}>
      <div className="flex">
        <div
          ...
          className='head1 w-full flex justify-between items-center max-w-7xl mx-auto'
        >
      ...
      {/* <div className="imgcontainer1 absolute bg-secondary">
        <img src={myself} alt="" className="object-contain"/>
      </div> */}
    </div>

    <div className="slide-container absolute">
          <Slide arrows={false}>
